# Generated by Powerlevel10k configuration wizard on 2023-10-30 at 19:03 CET.
...
() {
  ...
  # ALVARO - Changed background color
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=$'\uF303 ' # Adds extra space after os icon 
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%40F'   # green foreground
  ...
  # Custom icon.
  # ALVARO - Esta linea estaba comentada, la he descomentado para poner el contenido vacio
